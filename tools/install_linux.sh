...
OPT_DIR="$HOME_DIR/.local/opt/shadowfetch-bowling"
SIZES=(16 22 24 32 48 64 128 256 512)
NAME="shadowfetch-bowling"
...
Name=Shadowfetch Bowling
GenericName=Bowling
Comment=Ten-pin bowling for Linux
Exec=${NAME}
TryExec=${NAME}
Icon=${NAME}
Terminal=false
Categories=Game;
Keywords=bowling;tenpin;pins;shadowfetch;
StartupNotify=true
StartupWMClass=Shadowfetch Bowling
EOF
...
echo "Installed Shadowfetch Bowling launcher: $BIN_DIR/${NAME}"
